 ...
 * Source: src/content/stays.granada.md
 */
import type { CityStay } from '../data/stays'

export const STAYS_DATA: CityStay[] = [
  {
    "cityId": "granada",
