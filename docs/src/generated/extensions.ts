...
export const EXTENSIONS_DATA: CityExtensions[] = [
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 票務備忘與操作順序：先鎖日期＋Nasrid 時段，再讓其他安排讓路；提早進園是避免趕路與排隊壓力的關鍵。\n先做：\n1. 上 Patronato 官方買票\n2. 選日期 + Nasrid Palaces 時段\n3. 把這個時段當作全日錨點（其他安排都讓路）\n\n當天：至少提早 30–45 分鐘進園（園區很大，走到入口要時間；排隊也可能拉長）。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 交通與動線重點整理：火車/巴士往返，把它當「城市海邊補給日」最對味；走路量可控、節奏也更像休息而不是再拚景點。\n交通以火車/巴士為主（先查班次再排回程）。\n到 Málaga → 海邊散步/午餐 → 傍晚回 Granada。建議抓整天或晚出早回。"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：如果當天太累，直接留在 Granada 做 Hammam/茶館也很完整；把休息當成行程的一部分會更舒服。\n如果當天太累：直接留在 Granada（Hammam/茶館）會更舒服。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
  ...
  },
  {
    ...
    "trips": [
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "如果你只想把延伸日排得「順、好撤退、少踩雷」，先看這一段就夠。你不用背細節，出門前掃一眼，當天照著挑題目就很穩。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 怎麼挑題目最不後悔：先用風浪／膝蓋／交通成本／想看什麼做決策，把延伸日選成順、好撤退、少踩雷的版本。\n\n挑題目的順序，我會用下面這幾句當「決策句」（可直接照做）。你只要回答「我今天最在意的是什麼」：風浪？膝蓋？交通成本？想看大景？就能很快選到不後悔的版本。\n\n- **先看風浪**：風浪大、或你不想賭船，優先選 `sagres-cabo` / `silves-monchique` 這種「不靠海況也成立」的行程。\n- **膝蓋想休息**：想走平地、走木棧道就好，選 `alvor`；想更像度假散步＋咖啡，選 `luz`。\n- **想看代表級岩岸但不想出海**：直接選 `carvoeiro-marinha`（陸上觀景點就很值）。\n- **很想解鎖 Benagil**：把 `benagil` 當「可取消的加碼」，先讀新規與 `### comfort` 再決定；下午起風就果斷改陸上（通常 `carvoeiro-marinha` 最好接）。\n- **想要半日慢走、吃一頓舒服的**：選 `ferragudo`，重點放在河岸坐下來吃魚，不追大景。\n- **想把節奏切回城市生活**：選 `faro`（老城慢走＋補給）；想加碼水上放空，就再接 `ria-formosa`。\n- **想要更安靜的小城**：選 `tavira`，但請預留交通時間、回程別壓太晚。\n- **一天只選 1 個「遠」點**：例如 Benagil / Carvoeiro 這種，剩下時間留給吃飯、回程與 Plan B，體感會好很多。"
          },
          {
            "key": "route",
            "title": "行程建議（Route）",
            "content": "@card: 交通/移動通用原則：叫車、租車與火車的取捨都在這裡；先把移動方式決定好，延伸日就更像度假而不是轉乘硬仗。\n\n幾個很實用、很「省腦」的原則（跑任何延伸日都用得到）：\n\n- **叫車（想省時）**：很多旅客經驗是 Bolt 常比 Uber 便宜；市區短程通常很划算。\n- **租車（想更自由）**：圓環規則是「不是第一個出口就走內側」，要出去再切外側；熱門海灘/觀景點停車位小，想停到正常車位就抓 `9:00–9:30` 前到。\n- **火車（跨城最穩）**：`CP（Comboios de Portugal）` 用官方網站/App 查班次買票最省腦（價格與車次以官方為準）。"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "一句話定位：這天比較像「去看海的規模」，不是跑景點清單。風很大、視野很硬派，但你就算完全不上船，也照樣會覺得值。\n\n抓一個好理解的對比：Lagos 是精緻、好親近的度假海岸；Sagres / Cabo 更像「世界盡頭」——粗獷、空曠、帶點被海風磨過的歷史感。你不用走很遠，站在岬角看出去就懂它的震撼點。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 最適合放在風浪大或 Benagil 取消那天：不上船也能吃到「世界盡頭」的懸崖尺度；四月初風大偏冷，防風保暖很重要。\n最適合放：Benagil 取消／風浪大那天，或多住的加碼日（不需要好海象）。四月初風通常偏大，外套＋防風層記得帶。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
          ...
          },
          {
            ...
            "content": "@card: 停留時間抓法：Sagres 1.5–3 小時、Cabo 30–60 分鐘；風大就縮短，把保暖與安全放第一，寧可快閃也不要久站硬撐。\n- Sagres（堡壘＋海岸短走）：1.5–3 小時\n- Cabo de São Vicente（燈塔/懸崖觀景）：30–60 分鐘（風大就更短）"
          },
          {
            "key": "cost",
            "title": "花費/票務（Cost & tickets）",
            "content": "@card: 花費結構很單純：交通＋Sagres 堡壘門票；不估死數字，先抓「會花在哪」與「值不值得加」就好，避免為了省小錢耗掉體力與時間。\n- 門票/交通都以官方為準；保守抓法是「不估死價格」，只抓結構。\n- **交通**：Lagos ↔ Sagres/Cabo 的公車費用（視路線/班次）\n- **景點**：Sagres Fortress（堡壘）需要門票；票價請以官網為準（官網目前一般票標示為 `€10`，且常見會有年齡/身分折扣）"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B：風太大就只留觀景點短停、不久站；把它當平坦開闊散步，不要硬貼懸崖邊，把體感留在「震撼」而不是「被風吹到不爽」。\n如果風太大：只留觀景點短停，別在懸崖邊久站。\n\n如果你們本來是想「像 Lagos 那樣走懸崖步道」：Sagres 更適合把它當作「平坦、開闊、風大、視野壯闊」的景觀散步；把目標改成 2–3 小時舒服走完堡壘岬角一圈，體驗會更好。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "一句話定位：把節奏從「海岸線」切回「古城＋山城」。Silves 是主菜；Monchique 是天氣好、你還有力氣時再加碼的甜點。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 想換口味的內陸日：Silves 是主菜、Monchique/Fóia 看天氣加碼；陰天或不想被海風限制時特別成立，起霧就把重點放回 Silves。\n最適合放：你已經看夠海岸線、想換口味的一天；或天氣陰但不想被海風限制的一天（Silves 尤其適合）。Monchique/Fóia 視野很看天氣，若起霧就把重點放回 Silves。\n\n如果你剛好在 8 月來：Silves 有很有名的 Medieval Festival（中世紀節）（人會多，但很有氣氛）。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
          ...
          },
          {
            "key": "cost",
            "title": "花費/票務（Cost & tickets）",
            "content": "@card: 花費/票務與體力成本：交通、門票與走路量的保守抓法都在這裡；先抓結構避免回程被拖崩，也更容易決定要不要加碼 Monchique。\n以官方查詢為準（班次/票價會變動）。保守抓法：\n- **交通**：火車/巴士＋可能的接駁（Silves 車站 ↔ 老城）\n- **景點**：Silves 城堡若入內會有門票\n- **體力成本**：坡＋走路量較大，穿好走鞋、留水與點心最實在"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "一句話定位：半日就很舒服的「河口明信片漁村」。你不用追大景，重點是巷弄慢走，然後找一張河景座位坐下來吃一頓。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 半日就很舒服的河口漁村：適合低壓力回血日，不追大景，追巷弄慢走＋河景座位坐下來吃一頓的度假感。\n最適合放：你想排「低壓力、半日就收工」的一天；或前一晚走太滿、隔天需要回血但又不想整天待在 Lagos 的那天。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
          ...
          },
          {
            "key": "cost",
            "title": "花費/票務（Cost & tickets）",
            "content": "@card: 花費結構：交通到 Portimão＋過河小船（若有）＋把預算留給河邊用餐；這天最值得花的通常不是門票，而是「坐下來吃一頓」。\n以當天交通方案為準。保守抓法：\n- **交通**：Lagos ↔ Portimão（火車/巴士）\n- **加碼**：若有渡船/小船過河則另計\n- **餐飲**：河邊用餐通常比景點門票更值得預算"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B：如果水上計程車/過河小船不確定，就把 Portimão 當主菜（河岸散步＋咖啡/博物館）照樣舒服；或直接叫車回 Lagos 省掉轉乘。\n如果當天水上計程車/過河小船不確定：就把 Portimão 當成主菜（河岸散步＋咖啡/博物館），照樣是一個舒服的半日；或直接叫車從 Portimão 回 Lagos（省掉轉乘）。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "一句話定位：當你看了很多海岸線後，去 Faro 把節奏切回「城市生活」：老城慢走＋補給。它很適合當休息日，也很適合當強風天的替代方案。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 適合把節奏切回「城市生活」的一天：走老城＋補給很舒服；海風太大不想再走岩岸步道時，Faro 也很穩、好撤退。\n最適合放：你想「走城市、補給、節奏放慢」的一天；或海風太大、你不想再走岩岸步道的一天。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
          ...
          },
          {
            "key": "cost",
            "title": "花費/票務（Cost & tickets）",
            "content": "@card: 花費/票務與時間成本提醒：交通＋（可選）人骨禮拜堂小額門票＋（可選）潟湖船遊；不做加碼也能很完整，先抓結構就好。\n以官方查詢為準。保守抓法：\n- **交通**：Lagos ↔ Faro（火車/巴士）\n- **門票**：若去 Capela dos Ossos（人骨禮拜堂）通常會有小額門票\n- **加碼**：若參加 Ria Formosa 的船/導覽行程則另計（不做也完全成立）"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
      ...
      {
        "id": "ria-formosa",
        "title": "Ria Formosa 自然公園（潟湖船遊：最穩的水上放空）",
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "一句話定位：如果你想「坐船看自然」但又怕外海顛簸，Ria Formosa 是阿爾加維最友善的選擇：看的是潟湖、沙洲與鳥，不是浪花與岩洞。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 想做水上活動但不想賭外海顛簸：Ria Formosa 看的是潟湖/沙洲/鳥類，節奏更溫柔、也更容易「坐著放空」。\n最適合放：你們想要「水上活動」但不想賭海象的一天；或想要更溫柔節奏、在船上吹風看景的一天。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 玩法重點：從 Faro/Olhão/Tavira 碼頭上船、選 1–2 小時短程，把它當「潟湖散步」；期待值放在自然與安靜感，而不是洞穴與浪花。\n用對玩法就會很舒服（省力版）：\n- 出發點選 Faro / Olhão / Tavira 的 marina（碼頭上船通常最穩、也最好上下船；以當日供應為準）\n- **選 1–2 小時短程**：把它當成「潟湖散步」，不是跑景點\n- **期待值調整**：重點是鳥類（常見有鷺鳥、琵鷺等；季節對了也可能看到火烈鳥）＋沙洲島嶼的安靜感"
          },
          {
            "key": "cost",
            "title": "花費/票務（Cost & tickets）",
            "content": "@card: 花費抓法：不估死價格，先抓「付的是船＋導覽＋時長」；挑短程與碼頭上船通常更穩，也更符合放空日的節奏。\n船型、時長、是否有導覽差異很大，建議不估死價格：抓概念是「付的是船與導覽」，而不是門票。"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B：臨時沒訂到船，就把這天改成 Faro/Olhão 老城散步＋市場/咖啡的低壓力版本；重點是休息與補給，不必硬追水上活動。\n如果臨時沒訂到船：就改成 Faro / Olhão 老城散步＋市場/咖啡，一樣是低壓力的一天。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "一句話定位：Tavira 是「不追大景、追舒服」的河岸小城；氣質跟 Lagos 很不一樣，但交通成本也更高。你如果想把行程排得輕鬆，回程時間一定要留得更寬鬆。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 想要安靜河岸小城的一天：Tavira 不追大景、追舒服，但交通成本更高；越早出發、越早回程，體感會更像慢遊而不是趕車。\n最適合放：你們想要「安靜散步＋河岸小城」的一天，而且願意為了轉乘付出一點交通時間的那天（建議越早出發越好）。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "一句話定位：你如果想要「離 Lagos 最近、最不折騰、又很像度假」的半日，Luz 幾乎是標準答案：海濱長廊平坦好走。主菜就是慢走＋坐下來看海，不需要追景點。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 想出門但不想走太多的一天：Luz 是「離 Lagos 很近、平坦海濱長廊＋坐下來看海」的低壓力午後選項，度假感很直接。\n最適合放：想出門但不想走太多的一天；或你想找一個「不擠、又能看海」的午後。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 最省力玩法：Lagos 叫車/自駕 10–15 分鐘到，主菜只做海濱長廊慢走＋找座位坐下來看海；狀態好再加一小段村內巷弄即可。\n最省力玩法（直接照抄）：\n- Lagos → Luz：車程通常 10–15 分鐘（叫車/自駕最省腦；公車班次以當日為準）\n- **主菜只做一件事**：沿海濱長廊慢走，累了就挑一家露天咖啡座坐下來看海\n- 如果你們那天狀態很好：再加碼「村內短巷弄」走到教堂附近就好，不用爬高、不用追點\n\n濱海長廊「確切走法」（幾乎零坡、零階梯）：\n- **起點（地標式集合點）**：把車停/下車在教堂附近最省力：  \n  [Igreja de Nossa Senhora da Luz（Google Maps）](https://www.google.com/maps/search/?api=1&query=Igreja%20de%20Nossa%20Senhora%20da%20Luz%20Praia%20da%20Luz)\n- **中段**：從教堂一帶走到海邊主步道後，沿著海灘平行慢慢走。這段的重點是：\n  - 路面通常是鋪設好的步道（好走、寬、平）\n  - 長椅多、露天餐廳與咖啡座也多：累了就坐（不要追距離）\n- **終點（西側視野變開闊）**：走到長廊靠西側，視野會更接近岩岸一點，但依然以「平地看海」為主（不需要像懸崖步道那樣一直注意腳下）。\n- **走多久最剛好**：保守抓法是「走到想坐下就回頭」。單程 15–30 分鐘通常就很舒服（依當天風勢與體感調整）。\n\n省力加分點（為什麼它真的適合慢遊）：\n- **設施密度高**：洗手間、餐廳、商店都在旁邊，臨時想撤退很容易。\n- **風大時的策略**：直接把行程改成「短走＋坐下來看海」，體驗反而更像度假。"
          },
          {
            "key": "cost",
            "title": "花費/票務（Cost & tickets）",
            "content": "@card: 花費結構很單純：交通＋餐飲；很適合把預算花在「坐下來吃一餐/喝一杯」與看海本身，幾乎不用門票成本。\n幾乎不用門票：主要花費在交通與餐飲（很適合把預算花在「坐下來吃一餐」）。"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B：風大就照走長廊但縮短時間，直接改成「咖啡/午餐＋看海」模式；Luz 的價值在平坦好撤退，不在於一定要走多遠。\n如果風大：照走長廊但縮短時間，直接改成「咖啡/午餐＋看海」模式，一樣很成立。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 膝蓋想休息的半日：全平木棧道＋潟湖安靜感，強風天也低風險；適合把節奏放慢、走一段就收工的那天。\n最適合放：你想「半日走走就好」或需要照顧膝蓋/體力的那天；也很適合當作強風天的低風險選項。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
          ...
          },
          {
            "key": "cost",
            "title": "花費/票務（Cost & tickets）",
            "content": "@card: 花費結構很單純：交通＋餐飲；木棧道本身免費。把預算留給「坐下來吃一餐」會比追更多點更舒服。\n以當天交通方式為準（公車票價/班次）。木棧道本身不用門票，主要花費會在交通與餐飲。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "一句話定位：這是「不靠出海」也能把阿爾加維代表級岩岸收好的一天：Algar Seco 的岩洞/天然窗 + Marinha 的上方觀景點。重點放在「上面看」，不把自己逼去下沙灘、爬上爬下。\n\n氣氛補充（為什麼很多人更喜歡 Carvoeiro）：\n- Carvoeiro 很像「明信片小鎮」：白房子堆在海岸邊，中間夾著一小片沙灘與灣；節奏比 Lagos 更偏「優雅、散步、坐下來看海」。\n- 但提醒：它畢竟是建在海岸地形上，部分路段仍會有坡/階梯；最省力的玩法是把重心放在木棧道與上方觀景點。"
          },
          {
            "key": "images",
            "title": "images",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "Benagil 是阿爾加維最「名片級」的海洞，但現在的重點不再是「進去踩沙灘拍照」，而是 在合法方式下、用很短的時間進洞內仰望天窗。如果你抱著老照片那種玩法去，很容易失望或踩規則。（所以我才把它放在延伸：當作「可取消的加碼」會最舒服。）\n\n成因一句話（看懂會更有感）：它同時是「海浪從下往上挖空的海蝕洞」＋「雨水從上往下溶蝕弱化後的頂部塌陷（天窗）」的合體。\n\n它為什麼值得（用很直覺的方式講）：\n- **那個“眼睛”（The Eye）**：洞頂的圓形天窗把光打進來，洞內會出現很像「天然教堂採光」的光影感。\n- **色彩對比**：暖色石灰岩洞壁 + 綠松石色海水，幾乎不用濾鏡就很像明信片。\n- **洞內沙灘是加分不是重點**：洞內確實有沙灘（潮汐會影響露出程度），但依 2024-08 新規，現在大多數情況下就是「只能看、不能下去踩」；把期待放在「抬頭看天窗」就對了。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "when",
            "title": "什麼時候去（When）",
            "content": "@card: 把 Benagil 當作可取消的加碼：風浪大很容易取消或品質打折；把期待放在「進洞內仰望天窗」的短時間回報，而不是登陸沙灘。\n最適合放：你們想做一個「阿爾加維招牌景」的那天；但如果風浪大，行程會很容易取消或品質打折，請把它當作 可取消的加碼（不是必做）。"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 新規預期先建立：不能游泳進洞、多數情況不能登陸沙灘；玩法以小船導覽或上方俯瞰為主，進洞停留通常很短，把「抬頭看天窗」當主菜。\n先建立正確預期（很重要，這會直接決定你會不會失望）：\n- 不能游泳進洞（安全/管制因素，規則已明確禁止）。\n- **多數情況下不能在洞內沙灘登陸**：就算是 kayak/SUP，也通常是「在水面上看」而不是下船踩沙灘。\n- **以導覽為主**：現在更偏向「小船導覽」或「有導遊帶的 kayak/SUP」這種玩法；而且因為有停留/流量管制，進洞時間通常會很短。\n\n兩種欣賞方式（省力結論：A 比 B 更省力）：\n- **A｜小船導覽（最省力）**：坐在船上看天窗與光影（能不能進洞、能停多久都看海況與管制）。很多洞穴船會順便帶你看沿線其他海蝕洞/海拱，體感 CP 值更高。\n- **B｜上方俯瞰（不想上船的備案）**：在 Seven Hanging Valleys Trail 一帶找安全的觀景點往下看洞口與天窗位置；務必留在圍欄內，不要靠崖緣。\n\n省力版「新規生存指南」（推薦直接照做）：\n- **避開 Lagos 長途船**：先到 `Carvoeiro / Portimão` 一帶，再上短程小船（把外海顛簸時間縮到最短）。\n- **下午風浪大就放棄**：改成 Praia da Marinha / Algar Seco 的陸上觀景點，體驗一樣很值。\n- **不暈船替代視角**：Seven Hanging Valleys Trail 走很短一段，從上往下看天窗與船進出（注意崖邊安全、不要靠近邊緣）。"
          },
          {
            "key": "comfort-benagil",
          ...
          },
          {
            "key": "cost",
            "title": "花費/票務（Cost & tickets）",
            "content": "@card: 花費抓法：不估死價格，先用船型/出發地/季節決定；小船導覽通常最省體力也最符合「看洞」需求，Kayak/SUP 更吃海況與體力。\n費用差異很大（船型、季節、出發地、是否含裝備/保險），所以不在這裡估死價格。抓概念：\n- **小船導覽**：通常最省體力、也最符合「只想看洞」的需求\n- **導覽 kayak/SUP**：比較吃體力與海況（也更看當天風浪）"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B：不要把 Benagil 當成必做；浪況不佳就改陸上 Marinha / Algar Seco 一樣很值得，把成功率放在「風景」而不是「一定要進洞」。\n不要把 Benagil 當成「一定要進洞」：浪況不佳就改成 Praia da Marinha / Algar Seco 這種陸上景點，體驗一樣很值得。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
            "content": "@card: 資料來源與查詢入口：2024-08 新規與限制整理、以及出發地/業者範例連結在這裡，想核對規則可從這段往下追。\nThe Portugal News（2024-08 新規生效：禁止游泳/禁止登陸等）：https://www.theportugalnews.com/news/2024-08-13/new-algarve-cave-access-rules-come-into-force/91286\n\nSul Informação（新規摘要/重點）：https://www.sulinformacao.pt/en/2024/08/regras-para-visitar-o-algar-de-benagil-entram-em-vigor-a-13-de-agosto/\n\nBenagil Cave（restrictions 彙整頁）：https://benagilcave.org/restrictions/\n\nCarvoeiroCaves（Carvoeiro 出發：Benagil Cave 1hr 小船範例）：https://www.carvoeirocaves.com/en/tours/benagil-cave-boat-tour/\n\nBenagil Express（Portimão 出發：洞穴船）：https://benagilexpress.com/en/"
          }
        ]
      }
    ]
  ...
  },
  {
    ...
    "trips": [
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "選擇可以很簡單，先想你要「題材」還是「舒服」：\n- 想要「三種文化」＋迷宮老城：選 `Toledo`（但老城有坡、有樓梯）。\n- 想要「一個超震撼的大景」＋走路負擔較可控：選 `Segovia`（水道橋很直接；再看體力加老城/城堡）。\n- 想要「王室題材加碼」，又不想跑太遠：選 `El Escorial / Aranjuez`（近郊火車可達、步行量可控）。\n- 想看「中世紀城牆本體」：選 `Ávila`（城牆很完整；不走上城牆也能很有感）。\n- 想看「地形超不一樣」，但願意更吃力：選 `Cuenca`（視覺很猛，但上坡多，容易累）。"
          }
        ]
      },
      {
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "這是一個走路負擔相對可控、但震撼很直接的一日：羅馬水道橋就是站在那裡你會立刻有感的等級，不需要做功課也會被打到。水道橋一帶相對平，想加老城再看體力（其實只看水道橋就回也成立）；交通用火車＋市區公車即可，不搭計程車也能完成（但要注意抵達站可能不是市中心）。建議搭早班到、避開團客最舒服——你看到的是「城市如何被水養出來」的基礎設施史。"
          },
          {
            "key": "images",
            "title": "images",
      ...
      {
        "id": "beyond-toledo-segovia",
        "title": "除了 Toledo / Segovia，馬德里周邊還有什麼？",
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "這是「馬德里王室題材」的加碼：El Escorial 偏權力＋宗教＋帝國的厚重氣質，Aranjuez 則更像王室的戶外與季節（花園/度假感），很適合多住兩天慢慢收，或雨天把戶外行程改成皇室建築/花園。兩地多為建築/花園，走路量可控、相對友善；交通以近郊火車為主，很適合不搭計程車的保守走法。不必拚很早也行，想避人潮就搭早一點的 Cercanías。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 交通與動線重點整理：用 Cercanías 把王室題材做成兩個舒服的一日（El Escorial / Aranjuez 各一天），走路量可控，也很適合多住加碼或雨天替代。\nEl Escorial：Renfe Cercanías（以官網地圖/時刻為準）。\n\nAranjuez：Renfe Cercanías（以官網地圖/時刻為準）。\nExtra Day A：El Escorial 一日。\n\nExtra Day B：Aranjuez 一日。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：下雨就把重點縮到城牆外觀＋咖啡即可；不要硬走全段，把節奏維持在舒服的一日散步。\n下雨：把重點縮到城牆外觀＋咖啡即可，不硬走全段。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
        ...
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "這是一個不用太早出門、也不用買長途票的低風險半日備案：搭近郊火車就能換到不同城市氛圍，老城散步＋大學城的文學氣質更像文化散步，不像景點衝刺。地形幾乎全平地，很適合不想爬樓梯；交通是近郊火車＋步行，完全符合不搭計程車。你可以晚點出門也行，想更舒服就早到、午餐前走完最順。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：當天只想休息，就留在 Madrid 逛市場/咖啡/公園也成立；把休息當作行程的一部分會更舒服。\n當天只想休息：直接留在 Madrid 逛市場/咖啡/公園也成立。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：只想低風險就改去 Alcalá（半日）或留 Madrid 緩衝；不要勉強把昆卡塞進疲勞日。\n只想低風險：改去 Alcalá（半日）或留 Madrid 緩衝。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
      ...
      },
      {
        ...
        "sections": [
          ...
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：天氣不好就縮成「主廣場喝咖啡＋簡單午餐」即可；小鎮感依然很滿，不需要硬走滿巷弄。\n天氣不好：把行程縮成「主廣場喝咖啡 + 簡單午餐」即可；整體仍然很有小鎮感。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
  ...
  },
  {
    ...
    "trips": [
      ...
      {
        "id": "monserrate",
        "title": "蒙塞拉特宮（Monserrate）（避人潮的舒服收尾）",
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "如果你已經被 Pena 擠到煩、又不想放棄 Sintra 的精緻，Monserrate 很適合當作舒服的收尾：花園散步為主、節奏可以很慢，拍照也好看，重點是終於能好好逛而不是一直被人潮推著走。它把 Sintra 那種浪漫主義「把自然當舞台」的美學延伸做得很完整，但人通常少很多。交通以公車/接駁為主（先看當天路線與班次），也不必拚很早，放在人潮最煩的一天最後一站剛剛好。"
          },
          {
            "key": "images",
            "title": "images",
            "content": "@card: 圖庫：先用畫面判斷你對不對這個題材；需要細節再往下讀。\n{{gallery:Monserrate|https://commons.wikimedia.org/wiki/Special:FilePath/Monserrate_Palace_-_Sintra,_Portugal_(8451615855).jpg?width=1800|https://commons.wikimedia.org/wiki/Special:FilePath/Pal%C3%A1cio_Monserrate_(1).jpg?width=1800|https://commons.wikimedia.org/wiki/Special:FilePath/Garden_of_Mexico_in_the_gardens_of_Pal%C3%A1cio_de_Monserrate,_Sintra,_Portugal_04.jpg?width=1800}}"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 交通與動線重點整理：把 Monserrate 當作「避人潮的舒服收尾」；花園散步為主、節奏慢，適合放在 Pena 後或 Regaleira 後當第二站。\n做法：把 Monserrate 當作 Day B 的第二站（Pena 後）或 Day A 的收尾（Regaleira 後）。\n半日/收尾版：Pena（按時段）→ Monserrate（走花園＋休息）→ 回鎮上吃甜點。建議抓 2–3 小時（含交通）。"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：時間不夠就優先走花園＋外觀撤退，不必硬塞室內；把它當「舒服」的一站才會更值。\n如果時間不夠：Monserrate 優先走花園＋外觀就撤，不用硬塞室內。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
      ...
      {
        "id": "capuchos",
        "title": "卡普舒什修道院（Convento dos Capuchos）（森林修道院：小眾但很有味道）",
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "如果你在 Sintra 看了一堆浪漫主義的華麗，Capuchos 會用「森林＋極簡苦修」把你直接拉回地面，很有效換腦：洞穴/花崗岩與修道院的生活痕跡不是豪華建築，而是一種貼近自然的生活方式。這裡路面比較原始，雨天可能濕滑，怕滑就要保守；而且公車不方便，不搭計程車的話不建議硬塞。真要去就早去早回，天氣差就乾脆取消，體感會更好。"
          },
          {
            "key": "images",
            "title": "images",
            "content": "@card: 圖庫：先用畫面判斷你對不對這個題材；需要細節再往下讀。\n{{gallery:Capuchos|https://commons.wikimedia.org/wiki/Special:FilePath/Convento_dos_Capuchos_-_Sintra_(1).jpg?width=1800|https://commons.wikimedia.org/wiki/Special:FilePath/Convento_dos_capuchos_(Sintra)_-_Claustro.jpg?width=1800}}"
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 交通與動線重點整理：公車不方便，適合當「小眾換腦題材」；不搭計程車就要更保守、不要硬塞，雨天更要把滑倒風險放在第一位。\n交通：公車不方便。把它當作特別題材的一站，不硬塞；不搭計程車就更不建議。\n半日：Capuchos → 回鎮上吃甜點/休息（當作低人潮備案日）。交通 + 參觀：抓 3–5 小時較舒服。"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：霧雨太重就改成鎮上王宮/咖啡店；把這段當成「可取消加碼」會更舒服。\n如果霧雨太重：改成鎮上王宮/咖啡店（山裡會更冷更濕）。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
      ...
      },
      {
        ...
        "title": "羅卡角（Cabo da Roca）+ 海邊白屋村（Azenhas do Mar）（海岸線加點）",
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "這個加點是把 Sintra 的山城故事接到大西洋邊界：風很大，但視野會讓你覺得自己真的到了「最西端」。Cabo da Roca 的象徵感很強，Azenhas 則用白屋與峭壁把畫面直接做滿；但它很吃天氣，天氣好才值。地形是懸崖風口（走路不一定長，但站久很消耗），交通以公車為主，班次/轉乘務必抓寬，不搭計程車就不要壓時間；建議早去比較不趕，風大時就短停拍照收工即可。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 交通與動線重點整理：公車班次要抓寬，天氣好才推薦；把它當「海岸線加點」而不是必做主菜，避免把一天變成趕路日。\n交通以公車為主，班次要抓寬。這個加點很吃時間，別壓太緊。\n加點版（天氣好才推薦）：上午山上宮殿 → 下午海岸線（Roca / Azenhas 擇一）→ 傍晚回里斯本。建議抓整天才不會變成趕路日。"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：風雨很大就直接取消海岸線加點，回鎮上喝咖啡/逛王宮更舒服；短停拍照就好，不必硬站在風口。\n如果風雨很大：直接取消海岸線加點，回鎮上喝咖啡/逛王宮會更舒服。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
      ...
      {
        "id": "coast-cascais",
        "title": "沿海連動：辛特拉（Sintra）+ 卡斯凱什（Cascais）（海岸放鬆日）",
        "sections": [
          {
            "key": "notes",
            "title": "重點（Notes）",
            "content": "這個兩天拆法的目的只有一個：讓你每天都舒服。Sintra 本來就容易累，硬把海岸線塞進同一天只會讓兩邊都不好玩；拆成「一天跑山、一天跑海」才是最順的節奏。Day 1 早上做 Sintra 把票務/人潮最硬的部分先處理掉，Day 2 就晚點出門去 Cascais 放鬆走海岸線；兩天都能用火車/公車完成，完全符合不搭計程車，而且每天都能走得很保守、不會走到爆。"
          },
          {
            "key": "images",
            "title": "images",
          ...
          },
          {
            "key": "how",
            "title": "怎麼去（How to go）",
            "content": "@card: 交通與動線重點整理：把「一天跑山、一天跑海」拆開最舒服；先完成 Sintra 的票務難題，再把第二天留給 Cascais 放鬆走海岸線。\n做法：先把 Sintra 的最難票務完成，再把第二天留給海邊（不用擠在同一天）。\nDay 1：Sintra（Pena/Regaleira 依時段）→ 回里斯本。\n\nDay 2：Cascais 海岸線散步（輕鬆收尾）。\n兩天各自都能做成早出晚回或半日，彈性大。"
          },
          {
            "key": "backup",
            "title": "雨備/Plan B（Backup）",
            "content": "@card: Plan B 與可撤退版本：天氣不好就把海邊改成里斯本室內點（博物館/市場），不浪費體力；核心是「每天都舒服」。\n如果天氣不好：把海邊改成里斯本室內點（博物館/市場），不浪費體力。"
          },
          {
            "key": "sources",
            "title": "資料來源（Sources）",
