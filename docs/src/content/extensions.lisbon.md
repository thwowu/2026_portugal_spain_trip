...
閱讀方式：
- 先看每段最上面 3 行：**地形（樓梯/上坡）**、**交通（能否全程大眾運輸）**、**早起安排（早班人少）**
- 如果只想選 1 個：**Cascais（最穩、最省力）**；想看古城就選 **Évora（走路完成）**
...
## setubal-arrabida | Setúbal + Arrábida（海岸/山海景，一日）
