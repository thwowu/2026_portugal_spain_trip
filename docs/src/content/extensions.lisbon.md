...
### how
@card: 交通與動線重點整理：怎麼去、怎麼串、以及時間抓法（以當日班次/狀況為準）；先把交通搞定，再決定要不要把海岸段加進來。
交通方式（不自駕最實際通常是巴士）。
...
### cost
@card: 花費/票務與時間成本提醒：以官方查詢為準；如果轉乘太麻煩，縮成「只去 Óbidos」反而更穩、更符合延伸日的節奏。
交通票價會因班次/購票時間變動：以 Rede Expressos 搜尋結果為準。若你不想處理轉乘，最穩就是把行程縮成「只去 Óbidos」，或直接改走 Évora / Cascais 這種更省腦的近郊。

### backup
@card: Plan B 與可撤退版本：遇到下雨、風大或班次對不上時，怎麼縮短/怎麼換題目，避免把一天押在轉乘與不確定性上。
...
### backup
@card: Plan B 與可撤退版本：下雨時怎麼把散步縮短、把教堂/博物館當主菜，讓 Évora 仍然成立。
