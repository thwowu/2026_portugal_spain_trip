...
閱讀方式：
- 先看每段最上面 3 行：**地形（上坡/樓梯）**、**交通（火車/巴士能不能直覺到）**、**早起安排（早班比較順）**
- 如果只想選 1 個：**Guadix（火車來回、題材很不一樣）**；想要海邊城市就選 **Málaga（節奏很輕鬆）**
...
## sierra-nevada | Sierra Nevada（山景/雪線：好天加碼）
...
## nerja-frigiliana | Nerja + Frigiliana（海岸 + 白村，一日）
