...
為什麼去：摩爾式宮殿建築與庭院水景的巔峰級樣本，細節密度高，逛起來像走進一座活的建築博物館。它最初為要塞，13–14 世紀納斯里德王朝擴建為王宮城；1492 收復後成為王室資產，如今是世界遺產的重要核心。

建議停留：半天到一整天（看你走多慢＋拍照）。

### 軒尼洛里費花園（Generalife；通常含在套票裡，別錯過）
...
為什麼去：同樣是水景＋庭園的極致版本，但節奏更放鬆。和主宮殿搭配，整個 Alhambra 體驗才會完整。它傳統上被視為納斯里德王朝的夏宮／離宮花園區，延續伊斯蘭庭園「水與綠」的審美。

建議停留：1–1.5 小時。

### Day 12 市區主菜（推薦順序：平路先吃氛圍 → 再上坡看景 → 隨時好撤退）

#### 新廣場（Plaza Nueva）→ Darro 河谷入口
...
把它當成 Granada 的樞紐：走累就回到這附近補給/撤退。它位在舊城要道核心，長期是市中心往山坡歷史街區的入口與集散點。參考：`https://en.wikivoyage.org/wiki/Granada_(Spain)`

#### 達羅街（Carrera del Darro）＋悲傷大道（Paseo de los Tristes）
...
白天/傍晚走都漂亮，是 Granada 的明信片街段。河谷石橋、老建築立面與上方山城視角很有層次，不需要做功課，走一段就很 Granada。參考：`https://en.wikivoyage.org/wiki/Granada_(Spain)`、`https://wikitravel.org/en/Granada_(Spain)`

#### 巴紐埃洛阿拉伯浴場遺址（El Bañuelo；短停加分）
...
規模小但氛圍很對：拱頂、天窗與石柱會很快讓你進入中世紀伊斯蘭公共浴場的想像。它是 Granada 保存最完整、也最古老的摩爾式公共浴場遺跡之一。參考：`https://en.wikivoyage.org/wiki/Granada_(Spain)`

#### 格拉納達主教座堂（Granada Cathedral）＋皇家禮拜堂（Capilla Real）
...
#### 古市集巷弄（La Alcaicería；10–20 分鐘就有感）
...
巷弄尺度小、氛圍強，走一圈就有市集迷宮感。它原本與絲綢／手工品交易相關，延續了 Granada 作為安達盧斯城市的商業記憶。參考：`https://wikitravel.org/en/Granada_(Spain)`

#### 阿爾拜辛（Albaicín）老城散步（白天走比較舒服）
...
Alhambra 上山可搭公車減少爬坡。Albaicín 石階多，如果不想走太多，就只去一個眺望點拍照即可。

市中心平路散步：Cathedral 周邊 → Plaza Nueva → 河谷入口，是腿不想爆的低風險版本。參考：`https://en.wikivoyage.org/wiki/Granada_(Spain)`

## rain

Hammam、Granada 大教堂＋皇家禮拜堂、以及市中心茶館（Calle Calderería Nueva 一帶）都很雨天友善。

下雨時不要硬爬坡，把行程改成「茶館＋教堂＋室內」小圈組合更舒服。參考：`https://en.wikivoyage.org/wiki/Granada_(Spain)`

## views

Mirador de San Nicolás（夕陽/夜景都強）是最經典視角。想避人可以白天拍照、晚上只做氛圍散步不硬卡位。

想要更高更開闊：Mirador de San Miguel Alto（但走路更累）。參考：`https://en.wikivoyage.org/wiki/Granada_(Spain)`

## routes

Day 11 的錨點就是票上那個 Nasrid 時段：其他都圍著它排。園區很大，寧可少一點、走舒服一點，不要趕場。

如果你腳還有力：傍晚回市區後只加一段 Darro 河谷夜走就很夠（不用再上坡）。參考：`https://en.wikivoyage.org/wiki/Granada_(Spain)`

## skip

別賭現場買票。Nasrid Palaces 時段嚴格，遲到通常就進不去。

Day 12 不要把行程全押在上坡石階：選 1 個眺望點＋一段河谷街就很夠，保留體力移動去馬德里。

## practical

門票務必提早預約。官方以 `alhambra-patronato.es` / `tickets.alhambra-patronato.es` 為主，注意第三方代購。

Nasrid Palaces：嚴格分時入場。建議至少提前 30–45 分鐘進園並往宮殿入口移動（園區走路距離不短）。

四月初早晚偏冷且可能下雨，石板路更滑，鞋底防滑很重要。

refs：`https://en.wikivoyage.org/wiki/Granada_(Spain)`、`https://wikitravel.org/en/Granada_(Spain)`、`https://www.alhambra-patronato.es/en/visit/organize-your-visit/time-of-the-visit`

## food

Granada 經典是「點飲料送 tapas」。別追名店清單，挑人多但不拉客的店，隨機反而更穩。

茶館（tetería）很適合當雨天/休息備案。Alhambra 園區走很久，補水比吃更重要。

## photo

![Alhambra（Granada）](https://source.unsplash.com/gM1lnTTdWuE/1600x1000)

Nasrid 宮殿的庭院水景（光影很美，但人多要耐心等空景）、Darro 河谷街段（傍晚光線很漂亮）、Mirador de San Nicolás（日落）都是高回報。

## safety

石板路/坡道多，雨天很滑，小心腳下。人多區域注意財物，眺望點就是扒手熱點，前背＋拉鍊關好。

Alhambra 當天提早出發、預留園區走路時間，遲到可能直接損失 Nasrid 入場。
