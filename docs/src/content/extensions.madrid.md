...
- 如果只想選 1 個：**Segovia（水道橋最省力）**；想看古城故事再選 Toledo（但上坡較多）

## toledo | Toledo（UNESCO 古城，一日）
...
## escorial-aranjuez | 埃斯科里亞爾（El Escorial）/ 阿蘭胡埃斯（Aranjuez）（多住 +2 天的加碼）
...
## alcala | Alcalá de Henares（大學城：低風險半日）
