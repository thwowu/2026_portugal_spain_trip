...
閱讀方式：
- 先看每段最上面 3 行：**地形（風大/上坡）**、**交通（是否能靠火車/公車）**、**早起安排（早班比較順）**
- 如果只想選 1 個：**Alvor（最平、最好走）**；想看「大景」再選 Sagres/Cabo（但風很大）
...
## carvoeiro-marinha | Carvoeiro + Praia da Marinha（陸上岩岸代表作）
