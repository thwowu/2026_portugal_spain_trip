...
為什麼去：它與 20 世紀初的大型展覽/都市計畫密切相關，後來成為城市最具象徵性的公共空間之一。

建議停留：1–2 小時（含拍照＋公園散步）。

### 黃金塔（Torre del Oro）＋河岸步道（平路好走）
...
如果你只想加一個河邊地標，它是最省腦的：白天好拍、晚上夜景也很穩，走一段就能感受到 Sevilla 的河城氣質。它與河防與航運的歷史角色相關，見證 Sevilla 與 Guadalquivir 河之間的城市與貿易關係。參考：`https://en.wikivoyage.org/wiki/Seville`

### 塞維爾蘑菇（Setas de Sevilla / Metropol Parasol）：晚上的收尾點很穩
...
### 聖十字街區（Barrio Santa Cruz）：老城核心散步
...
想吃 tapas 或逛市場，比一直待在最觀光的老城更舒服。它長期以工藝與日常生活氛圍著稱，形成與觀光核心不同的 Sevilla 另一面。參考：`https://en.wikivoyage.org/wiki/Seville`

### 彼拉多之家（Casa de Pilatos）：室內細節回報很高
...
庭院、磁磚、細節都很值得，雨天也好用。它屬於貴族宅邸類的歷史建築，融合不同時期的建築與裝飾語彙，呈現 Sevilla 上層文化的生活樣貌。參考：`https://en.wikivoyage.org/wiki/Seville`

### 特里亞納市場（Mercado de Triana）：補給/在地市場感
...
比觀光美食市集更像「真正在買菜的市場」，很適合補給或吃幾樣小點就走。它承接 Triana 的社區日常機能，代表河對岸街區的生活脈動與飲食文化。參考：`https://wikitravel.org/en/Seville`

## easy

景點集中，可半天完成。如果只是中轉半天：西班牙廣場＋市中心散步就很夠。

Day 9 抵達傍晚用的超短散步：河岸/橋邊走走（Puente de Triana 一帶），tapas 隨便找一家吃，不用追名店。

海格力斯大道（Alameda de Hércules）晚間氛圍很舒服，適合想要「不是觀光老城」的夜散步。參考：`https://en.wikivoyage.org/wiki/Seville`

鬥牛場（Plaza de Toros）如果你對文化符號有興趣，路過看外觀拍照就好。參考：`https://wikitravel.org/en/Seville`

## rain

Real Alcázar（室內＋庭園）、主教座堂、Flamenco 表演都是雨天穩定解。

塞維爾美術館（Museo de Bellas Artes）也是很好的室內備案。參考：`https://en.wikivoyage.org/wiki/Seville`

## views

吉拉達塔（Giralda）是最典型的城市視角（需要走/坡道上塔）。

Setas 看夕陽是最輕鬆的視野方案。

如果 Semana Santa 擠爆：視野點可能人超多，改成白天去更舒服。河岸夕陽備案就是 Triana 橋附近找一段長椅坐著看天色變化，不用搶觀景台。參考：`https://en.wikivoyage.org/wiki/Seville`

## routes

如果你臨時多出完整一天（升級版）：早上 Alcázar（先預約/先入場）→ 午餐 tapas → 下午主教座堂/市中心散步 → 傍晚 Setas 夕陽 → 晚上 Flamenco。

如果你只有半天：西班牙廣場＋公園（主菜）→ 河岸散步（到 Torre del Oro 就好）→ tapas 收尾。

如果你有兩天：Day 1 Alcázar + Santa Cruz + 大教堂；Day 2 西班牙廣場 + Triana（市場/河岸/晚餐）。

## skip

旺季現場買 Alcázar 常常排隊很久，能線上先買就先買。

Semana Santa 期間不要把移動押在準時到：封路/人潮會讓你預估時間失準，把重點景點排在更早時段更穩。參考：`https://en.wikivoyage.org/wiki/Seville`

中午硬衝戶外會很快崩。塞維爾熱起來很誇張，中午安排午休/室內點更有效率。

## practical

Real Alcázar 建議線上購票（官方票務：`https://www.alcazarsevilla.org/`）。

春末到夏季很熱，中午避開曝曬（午休/室內景點）。

四月初（復活節）：Sevilla 的 Semana Santa（2026/3/29–4/5）人潮極大，市中心會有遊行＋封路。移動時間要抓寬，盡量住市中心步行可達。Alcázar/主教座堂這類熱門點越早預約越好。
...
Triana 一帶晚餐通常比老城核心區更像在地，也更容易不踩雷。

## photo

![Plaza de España（Seville）](https://source.unsplash.com/-obj1_oSNA4/1600x1000)

西班牙廣場、Alcázar 宮殿紋樣＋庭園水景、Setas 日落、Santa Cruz 小巷＋白牆/磁磚細節、Triana 橋夜景/河岸倒影，都是高回報畫面。

## safety

觀光區注意扒手（尤其人多的廣場、市中心步行街）。防曬補水很重要。
